      ...
      <main className="flex-1 px-6 py-12 max-w-3xl w-full mx-auto animate-fade-in">
        ...
        <section className="animate-slide-up">
          <p className="leading-relaxed text-[#102A43]/90 mb-6">
            As described in the <a href="https://www.spurly.io/terms-of-use" className="text-[#3A506B] underline hover:text-[#9BC7FF] transition-colors hover:no-underline">Terms of Use</a>, Spurly uses one or more artificial intelligence (AI) models, large language models (LLMs), and/or multimodal LLMs (MLLMs) that are the exclusive properties of their respective third-party providers (e.g., OpenAI, Anthropic, Google, Meta, etc.). The models owned by these third-party providers implement <a href="https://en.wikipedia.org/wiki/Large_language_model#Tokenization" className="text-[#3A506B] underline hover:text-[#9BC7FF] transition-colors hover:no-underline">tokenization</a>, in which inputs are converted into tokens. The number of tokens used to generate spur suggestions, extract profile information from screenshots, infer personality traits from profile pictures, and various other features of Spurly will vary substantially, e.g., depending on the number, size, and complexity of images, amounts of text, selected &ldquo;creativity level&rdquo; (i.e., model temperature), and numerous other factors that cannot be accurately forecasted. </p>
            <p className="leading-relaxed text-[#102A43]/90 mb-6">
            Spurly subscriptions provide a weekly allotment of tokens, as this arrangement logically aligns with the underlying models. Spurly guarantees that you will be able to use the full number of tokens available at your subscription level. Additionally, we implement a token margin designed to allow you to exceed the token limit at your subscription level free of charge so that you are able to complete a request for spur suggestions or other Spurly feature. However, Spurly cannot and does not guarantee any amount and/or quality of model-dependent and/or model-generated content and/or functionality that you will receive in return for those tokens. The number of spur suggestions that can be generated at each subscription level is explicitly indicated as an approximation (e.g., via approximately symbol &ldquo;≈&rdquo;), and those approximations assume a minimal amount of contextual information provided by the user. 
          </p>

          <p className="leading-relaxed text-[#102A43]/90 mb-6">
            The above information has been made readily available to you prior to subscribing to Spurly. By subscribing to Spurly, you are acknowledging and accepting the terms outlined in this disclaimer. You are free to cancel your weekly subscription at any time. If you are in your first week of subscription and are dissatisfied with the Service or need to downgrade your subscription level, please contact us and we will see that you are fully refunded. Questions and concerns should be directed to <a href="mailto:support@spurly.io" className="text-[#3A506B] underline hover:text-[#9BC7FF] transition-colors hover:no-underline">support@spurly.io</a>. We appreciate you.
          </p>

          <p className="leading-relaxed text-[#102A43]/90 pl-6 mt-2 space-y-1 text-sm">
            <u>Note regarding <strong>limitless</strong> subscription level</u>: As set forth above, Spurly does not have any degree of control or influence over the AI models utilized to generate spur suggestions and provide various other functionalities. As used in the Spurly subscription context, <strong>limitless</strong> only guarantees that Spurly does not impose a limit on your token usage. This guarantee does not imply that third-party providers will not impose a limit or throttle usage of their models separately from Spurly. As an example, one of the models underlying Spurly has a context window of 1,000,000 tokens, while another has a context window of 128,000 tokens. The <strong>limitless</strong> subscription level does not imply that you will be able to exceed that context window or that a third-party provider will not impose its own limits or otherwise throttle usage. As stated above, we explicitly do not guarantee any features, functionalities, content, availabilities, and/or performances that we do not fully control and implement.</p>
          <p className="leading-relaxed text-[#102A43]/90 pl-6 mt-2 space-y-1 text-sm">
            By subscribing to Spurly at the <strong>limitless</strong> level, you acknowledge and accept these terms, which have been made readily available to you prior to subscribing. You are free to cancel or downgrade your subscription at any time. If you are in your first week of <strong>limitless</strong> subscription and are dissatisfied with the Service or need to downgrade your subscription level, please contact us and we will see that you are fully refunded. Questions and concerns should be directed to <a href="mailto:support@spurly.io" className="text-[#3A506B] underline hover:text-[#9BC7FF] transition-colors hover:no-underline">support@spurly.io</a>. We appreciate you.
          </p>
        </section>
        <br />

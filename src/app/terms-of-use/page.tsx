    ...
    <div className="min-h-screen flex flex-col bg-[#F0F4F8]">
      ...
      <main className="flex-1 p-8 max-w-4xl w-full mx-auto">
        ...
        <p className="text-[#3A506B] mb-4">
          ...
          <h4 className="text-[#3A506B] text-base font-semibold mt-4 mb-2">7.1 License to Company</h4>
            <p className="text-[#3A506B] mb-4">
          ...
          <h4 className="text-[#3A506B] text-base font-semibold mt-4 mb-2">7.2 Ownership of Generated Content</h4>
            <p className="text-[#3A506B] mb-4">
